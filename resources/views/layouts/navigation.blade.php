    ...
    <div class="max-w-7xl mx-auto px-6 py-4 flex items-center justify-between">
        ...
        <div class="flex items-center space-x-8">
            ...
            <div class="flex items-center space-x-4">
                ...
                <a href="{{ route('awards.show') }}" class="font-semibold text-gray-700 hover:text-blue-800">Penghargaan</a>
            </div>
        </div>

        <div class="flex space-x-3 items-center">
            <a href="{{ route('profile.edit') }}" class="font-semibold px-4 py-2 hover:bg-gray-200 transition">
                Profile
            </a>
